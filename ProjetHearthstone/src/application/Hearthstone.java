...
public class Hearthstone {
	...
	public static ArrayList<ICarte> CreerCartesJaina(IJoueur j)
	{
		...
		ICarte givre = new Sort ("Eclair de givre", 2, j, new CapaciteSort("Attaque de givre", "inflige 3 pts de dégats aux personnages cibles", 3));
		...
		ICarte explosion = new Sort ("Explosion Pyrotechnique", 10, j, new CapaciteSort("Explosion Pyrotechnique", "inflige 10 pts de dégats a tous les serviteurs adverses", 10));
	...
	public static ArrayList<ICarte> CreerCartesRexxar(IJoueur j)
	{
		...
		ICarte tirarcanes = new Sort ("Tir des arcanes", 1, j, new CapaciteSort("Tir des arcanes", "inflige 2 pts de dégats au personnage cible", 2));
	...
	public static ArrayList<ICarte> CreerCartesNeutres(IJoueur proprietaire)
	{
		...
		ICarte chef_raid = new Serviteur ("Chef de Raid" , 3 , proprietaire , 2 , 2 , new Bonus ( " Bonus du chef de raid " , " Effet sur les serviteurs alliés donnant un bonus +1/0" , 1 , 0 ));  
		...
		ICarte gnome = new Serviteur ("Gnôme lépreux " , 1 ,proprietaire , 1 , 1 , new CapaciteDegats ( " Attaque du lépreux " , "Inflige 2 points de dégats au héros " , 2 ));
		...
		ICarte attaque_mentale= new Sort ( " Attaque mentale " , 2 ,  proprietaire , new CapaciteDegats ( "Attaque mentale " , "Inflige 5 points de dégats au héros " , 5));
	...
	public static void main(String[] args) throws HearthstoneException {
		...
		Heros Rexxar=new Heros("Rexxar" , new CapaciteSort ("Tir assuré ",
